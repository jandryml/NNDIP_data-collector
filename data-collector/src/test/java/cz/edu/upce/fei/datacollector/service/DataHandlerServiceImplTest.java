...
import cz.edu.upce.fei.datacollector.service.impl.DataHandlerServiceImpl;
...
class DataHandlerServiceImplTest {
    ...
    @Test
    void addData() {
        dataHandlerServiceImpl.addData("1;-10.00;10.00;10;10;10;".getBytes());
        dataHandlerServiceImpl.addData("1;10.00;20.00;20;20;20;".getBytes());
        dataHandlerServiceImpl.addData("2;30.00;30.00;30;30;30;".getBytes());
        dataHandlerServiceImpl.addData("3;40.00;40.00;40;40;40;".getBytes());
        dataHandlerServiceImpl.addData("1;10.00;35.00;600;300;24;asdads".getBytes());

        List<SensorData> result = dataHandlerServiceImpl.processData();
    ...
    void processingLoadTest() {
        for (int i = 0; i < 1000; i++) {
            dataHandlerServiceImpl.addData("1;0.00;0.00;0;0;0;".getBytes());
            dataHandlerServiceImpl.addData("1;10.00;10.00;10;10;10;".getBytes());
            dataHandlerServiceImpl.addData("2;20.00;20.00;20;20;20;".getBytes());
            dataHandlerServiceImpl.addData("3;30.00;30.00;30;30;30;".getBytes());
            dataHandlerServiceImpl.addData("1;10.00;35.00;600;300;24;asdads".getBytes());
        }
    ...
    void noValueProcessTest() {
        dataHandlerServiceImpl.addData("1;;;;;;".getBytes());
        dataHandlerServiceImpl.addData("1;;;;;;".getBytes());
        dataHandlerServiceImpl.addData("2;;;;;;".getBytes());
    ...
    void oneEmptyRecordProcessTest() {
        dataHandlerServiceImpl.addData("1;;;;;;".getBytes());
        dataHandlerServiceImpl.addData("1;10.00;10.00;10;10;10;".getBytes());
        dataHandlerServiceImpl.addData("1;20.00;20.00;20;20;20;".getBytes());
    ...
    void realDataProcessTest() {
        dataHandlerServiceImpl.addData("1;;;;;;".getBytes());
        dataHandlerServiceImpl.addData("1;;;10;10;10;".getBytes());
        dataHandlerServiceImpl.addData("1;;;20;20;20;".getBytes());
        dataHandlerServiceImpl.addData("2;;;;;;".getBytes());
        dataHandlerServiceImpl.addData("2;10.00;10.00;;;;".getBytes());
        dataHandlerServiceImpl.addData("2;20.00;20.00;;;;".getBytes());
